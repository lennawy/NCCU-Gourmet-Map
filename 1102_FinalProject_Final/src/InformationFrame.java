...
public class InformationFrame extends JFrame{
	...
	public InformationFrame(Restaurant r) {
		...
		schoolGate.setFont(new Font("Times new Roman", Font.PLAIN, 15));
		cousine = new JLabel("		餐點類型：" + r.getCuisine());
		cousine.setFont(new Font("Times new Roman", Font.PLAIN, 15));
		vegan = new JLabel("		是否提供素食：" + r.getVegan());
		vegan.setFont(new Font("Times new Roman", Font.PLAIN, 15));
		takeOut = new JLabel("		是否提供外帶：" + r.getTakeOut());
		takeOut.setFont(new Font("Times new Roman", Font.PLAIN, 15));
		seats = new JLabel("		內用座位數：" + r.getSeats());
		seats.setFont(new Font("Times new Roman", Font.PLAIN, 15));
		openTime = new JLabel("		營業時間：" + r.getOpenTime());
		openTime.setFont(new Font("Times new Roman", Font.PLAIN, 15));
		telefon = new JLabel("		電話：" + r.getTelefon());
		telefon.setFont(new Font("Times new Roman", Font.PLAIN, 15));
